...
- ◎ [Orbit](https://omarchyplugins.com/plugin.html?id=io.github.rohan-patnaik.window-switcher) : An Alt+Tab switcher with icons(like macos), angled-stack(like win7), and grid modes((like win11) for Omarchy Linux.
